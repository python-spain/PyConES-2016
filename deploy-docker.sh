...
$DOCKER_COMPOSE -f docker-compose.yml stop pycones2016
$DOCKER_COMPOSE -f docker-compose.yml rm -v -f pycones2016
$DOCKER_COMPOSE -f docker-compose.yml up -d --no-deps pycones2016
